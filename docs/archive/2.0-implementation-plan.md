> **ARCHIVED (2026-08-29).** The pre-implementation working plan the 2.0.0 release was built from, preserved verbatim as a record of the design rationale and scope decisions. The release has shipped; for the user-facing upgrade guide see [../MIGRATION-2.0.md](../MIGRATION-2.0.md), and for the shipped scoring model see [../AUDIT_BREAKDOWN.md](../AUDIT_BREAKDOWN.md).
