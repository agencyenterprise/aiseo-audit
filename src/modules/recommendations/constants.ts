export const RECOMMENDATION_MAP: Record<string, string> = {
  ...
  "Text Extraction Quality":
    "Improve the ratio of meaningful text content to markup. Pages with very low text density are harder for generative engines to extract useful content from.",
  "Boilerplate Ratio":
  ...
  "Word Count Adequacy":
    "Ensure the page has sufficient content (300-3000 words) to provide comprehensive coverage. Thin content is less useful for generative engines to reference.",
  "AI Crawler Access":
    "Your robots.txt is blocking AI crawlers. Ensure GPTBot, ClaudeBot, PerplexityBot, and Google-Extended are allowed. Blocking these crawlers means your content cannot be discovered or cited by generative engines.",
  "LLMs.txt Presence":
  ...
  "Lists Presence":
    "Add bulleted or numbered lists to organize information. Lists are easily extracted and reused by generative engines.",
  "Tables Presence":
    "Consider adding data tables for comparative or structured data. Tables are highly parseable by generative engines.",
  "Paragraph Structure":
  ...
  "Answer Capsules":
    'Place a concise answer (under 200 characters) immediately after each question-framed H2. 72% of AI-cited content uses this "answer capsule" pattern. Put the direct answer in the first sentence, then elaborate below.',
  "Step-by-Step Content":
    "Break down processes into clear, numbered steps. Step-by-step content is highly reusable by generative engines.",
  "Q/A Patterns":
    'Include and answer common questions your audience might have. Structure content to directly answer "what is", "how to" style queries.',
  "Summary/Conclusion":
  ...
  "Topic Consistency":
    "Align your main topics with your title and headings. Topic consistency helps generative engines understand what your page is about.",
  "Entity Density":
  ...
  "Attribution Indicators":
    'Attribute claims to specific sources or experts. Phrases like "according to" help generative engines trace information.',
  "Quoted Attribution":
  ...
  "Content Freshness":
    "Update your content to include a recent publication or modified date. 65% of AI crawler hits target content less than 1 year old. Content freshness acts as a hard gate for generative engine citations - stale content loses visibility regardless of quality.",
  "Structured Data":
    "Implement JSON-LD structured data and Open Graph tags to provide machine-readable context about your content.",
  "Schema Completeness":
    "Ensure your JSON-LD schema types include all recommended properties. Article schemas should have headline, author, and datePublished. FAQPage needs mainEntity. HowTo needs name and step. Complete schemas help LLMs attribute and trust your content.",
  "Entity Consistency":
  ...
  Readability:
    "Simplify language where possible. A Flesch Reading Ease score of 60-70 is ideal for broad generative reusability.",
  "Jargon Density":
    "Define technical terms or replace with simpler alternatives. High jargon density reduces generative reusability.",
  "Transition Usage":
